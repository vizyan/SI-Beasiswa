...
<body>
<div class="modal fade" id="modalBeasiswa" role="dialog">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="labelModalKu">Tambah Beasiswa</h4>
            </div>
            <!-- Modal Body -->
...
<?php echo form_open_multipart('admin/file_data');?>
    <?php $data = $this->session->userdata('data_login') ?>

  <div class="form-group">
    <label for="pic_title">Nama Beasiswa</label>
    <input type="text" class="form-control" name="name" value="<?= set_value('name'); ?>" id="name" required>
  </div>
    <div class="form-group">
    <label for="pic_title">tanggal buka</label>
    <input type="date" class="form-control" name="open_date" value="<?= set_value('open_date'); ?>" id="open_date" required>
  </div>
   <div class="form-group">
    <label for="pic_title">id</label>
    <input type="text" class="form-control" name="id_provider" value="<?php echo $data['name'] ?>" id="id_provider" required>
  </div>
  <div class="form-group">
    <label for="pic_title">tanggal tutup</label>
    <input type="date" class="form-control" name="close_date" value="<?= set_value('close_date'); ?>" id="close_date" required>
  </div>
  <div class="form-group">
    <label for="pic_desc">Deskripsi beasiswa</label>
    <textarea name="description" class="form-control" id="description" rows="3" required><?= set_value('description'); ?></textarea>
  </div>
  <div class="form-group">
	            ...
	            <div class="col-md-10">
	                ...
	                <div class="row">
                     <!-- Tombol untuk memicu modal -->
                                <button class="btn btn-primary btn-simple btn-xs" data-toggle="modal" data-target="#modalBeasiswa">
                  	         		 <i class="material-icons">add</i>tambah akun
                      			</button>

                      			<button class="btn btn-primary btn-simple btn-xs" data-toggle="modal" data-target="#modalForm">
                  	         		 <i class="material-icons">add</i>tambah beasiswa
                      			</button>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="td-actions text-right">
   	                                               <?php   if($adm->name==$data['name'])
                                                {
                                                    ?>
                                                     <a href="#" type="button" disabled rel="tooltip" title="tidak bisa dihapus" class="btn btn-primary btn-simple btn-xs">
                                                    ...
                                                    <a href="#" type="button" rel="tooltip" title="hapus" class="btn btn-primary btn-simple btn-xs" onclick="deletedd('<?php echo $adm->id_admin; ?>')">
                                                        <i class="material-icons" >delete</i>
                                                    </a>
                                                    <?php
                                                } ?>
