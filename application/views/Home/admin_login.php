            ...
            <div class="row">
                ...
                <div class="card">
                    <div class="card-header" data-background-color="purple">
                        ...
                        <p class="category">Admin - Sistem Informasi Beasiswa</p>
                    </div>
                    <br />
                    <br />
                    ...
                    <div class="card-content">
                        <form method="post" action="<?= site_url('login/admin') ?>">
                            <div class="row" style="padding-left:20px;padding-right:20px">
                                <div class="col-md-12">
                                    <div class="form-group label-floating">
                                        ...
                                        <input type="text" name="etUsername" class="form-control" >
                                    </div>
                                </div>
                            </div>
                            <div class="row" style="padding-left:20px;padding-right:20px">
                            ...
                            <center><a class="btn btn-primary btn-round" href="<?= site_url('home/register') ?>" style="min-width:125px">Register</a></center>
                            <br />
                            <a href="<?= site_url('home/user') ?>" class="pull-right" style="padding-right:20px"><p>Login Mahasiswa</p></a>
